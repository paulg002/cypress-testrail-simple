...
[![cypress-testrail-simple](https://img.shields.io/endpoint?url=https://dashboard.cypress.io/badge/simple/41cgid/main&style=flat&logo=cypress)](https://dashboard.cypress.io/projects/41cgid/runs) [![ci](https://github.com/paulg002/cypress-testrail-simple/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/paulg002/cypress-testrail-simple/actions/workflows/ci.yml) [![CircleCI](https://circleci.com/gh/paulg002/cypress-testrail-simple/tree/main.svg?style=svg)](https://circleci.com/gh/paulg002/cypress-testrail-simple/tree/main) ![cypress version](https://img.shields.io/badge/cypress-13.6.4-brightgreen) [![renovate-app badge][renovate-badge]][renovate-app]

> Simple upload of Cypress test results to TestRail

Read the blog post [Cypress And TestRail](https://glebpaulg002.com/blog/cypress-and-testrail/). For testing, [this is a private TestRail project](https://paulg002.testrail.io/index.php?/suites/view/1).
...
module.exports = async (on, config) => {
  // https://github.com/paulg002/cypress-testrail-simple
  await require('cypress-testrail-simple/src/plugin')(on, config)
}
```
...
You can let this utility find the Cypress specs (via [find-cypress-specs](https://github.com/paulg002/find-cypress-specs)) and extract the test case IDs. Instead of `--spec` parameter, use `--find-specs` flag.
...
- [paulg002/test-rail-example](https://github.com/paulg002/test-rail-example)
- [paulg002/test-rail-suite-example](https://github.com/paulg002/test-rail-suite-example)
